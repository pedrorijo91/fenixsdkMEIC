...
require_once('fenixapi/fenixedu.config.php') ;
require_once('fenixapi/RestRequest.inc.php');
...
class FenixEdu {
	...
	function getAccessTokenFromCode($code){
		...
		if($info['http_code'] == 200){
			...
			//echo "Access Token From Code Failed like a stundent doing ACED";
            //debug($req);
		}
	}
    ...
    public function getPersonCalendar() {
		return $this->get("person/calendar");
	}
